...
function IsInGrass()
    ...
    if Right == "0x357887" then
        tblua:KeyDown(0x41)
        tblua:Sleep(1000)
        tblua:PressKey(0x41)
    end
    if Bottom == "0x357887" then
        tblua:KeyDown(0x57)
        tblua:Sleep(1000)
        tblua:PressKey(0x57)
    end
    if Left == "0x357887" then
        tblua:KeyDown(0x44)
        tblua:Sleep(1000)
        tblua:PressKey(0x44)
    end
    ...
    while (true) do
        ...
        while tblua:IsInWorld() == true do
            ...
            if first > 1 then
                ...
                if a > enc then
                    aone = 1
                    local fup = tblua:GetPixelColor(1204, 148)
                    if fup == "0x143F5A" then
                        ::ftopo::
                        while tblua:IsInWorld() == true do
                            if aone > 0 then
                                repeat
            ...
            if second > 1 then
                ...
                if a > enc then
                    aone = 1
                    local sup = tblua:GetPixelColor(1235, 69)
                    if sup == ("0x70AB85") then
                        ::stopo::
                        while tblua:IsInWorld() == true do
                            if aone > 0 then
                                repeat
                        ...
                        while tblua:IsInWorld() == true do
                            if aone > 0 then
                                repeat
                                    ...
                                    tblua:KeyUp(0x44)
                                    aone = aone + 1
                                until aone > 13 or tblua:IsInWorld() == false
